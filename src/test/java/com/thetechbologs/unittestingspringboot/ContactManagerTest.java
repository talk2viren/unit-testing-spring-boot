...
import com.thetechbologs.unittestingspringboot.domain.ContactManager;
...
//    @Autowired
    ...
    public static void setupAll() {
        System.out.println("Should Print Before All Tests  ==> Callback");
    }

    @BeforeEach
    public void setup() {
        System.out.println("Instantiating Contact Manager  ==> Callback");
//        contactManager = new ContactManager();
    ...
    public void shouldCreateContact() {
        log.info("Inside Should create contact : "+contactManager);
    ...
    public void tearDown() {
        System.out.println("Should Execute After Each Test ==> Callback");
    }

    @AfterAll
    public static void tearDownAll() {
        System.out.println("Should be executed at the end of the Test  ==> Callback");
    }
}
